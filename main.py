...
music = pyglet.resource.media(random.choice(['music1.mp3','music2.mp3','music3.mp3']))
music.play()


# music_files = random.shuffle(['music1.mp3','music2.mp3','music3.mp3'] )
    ...
    def _initialize(self):
        ...
        for x in xrange(-n, n + 1, s):
            for z in xrange(-n, n + 1, s):
                # create a layer of bedrock an grass everywhere.
...
class Window(pyglet.window.Window):
    ...
    def on_key_press(self, symbol, modifiers):
        ...
        if symbol == key.W:
            ...
            self.set_exclusive_mouse(not self.set_exclusive_mouse)
